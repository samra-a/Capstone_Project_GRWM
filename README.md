...
5. Install React Icons - in your terminal, perform the following command: `npm install react-icons`

6. Install React Slick - in your terminal, perform the following command: `npm install react-slick`
